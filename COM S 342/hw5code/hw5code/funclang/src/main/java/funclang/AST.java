...
public interface AST {
	...
	public static class SwitchExp extends CompoundArithExp {

		public SwitchExp(Exp fst) {
			super(fst);
		}

		public SwitchExp(List<Exp> args) {
			super(args);
		}

		public SwitchExp(Exp fst, List<Exp> rest) {
			super(fst, rest);
		}

		public SwitchExp(Exp left, Exp right) {
			super(left, right);
		}
